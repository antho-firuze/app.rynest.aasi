...
class ExamStageTooEarlier extends ConsumerWidget {
  const ExamStageTooEarlier({super.key});
        ...
        body: RefreshIndicator(
          ...
          child: ListView(
            children: [
              ...
              5.height,
              CustomCard(
                title: const Text('Jadwal Ujian Belum Masuk').tsTitleL().center().clr(oWhite),
                subTitle: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: const Text(
                          'Mohon maaf, jadwal anda dalam mengikuti Ujian Lisensi AASI belum masuk. Untuk lebih jelasnya silahkan anda cek Menu Jadwal Ujian.')
                      .tsBodyM()
                      .center(),
                ),
                child: Column(
