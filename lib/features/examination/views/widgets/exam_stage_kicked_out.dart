...
class ExamStageKickedOut extends ConsumerWidget {
  const ExamStageKickedOut({super.key});
        ...
        body: RefreshIndicator(
          ...
          child: ListView(
            children: [
              ...
              5.height,
              CustomCard(
                title: const Text('Duplikasi Login Terdeteksi').tsTitleL().center().clr(oWhite),
                subTitle: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: const Text(
                          'Kami melihat adanya login baru di perangkat lain, karena itu anda otomatis ter-logout dari Ujian. Jika anda ingin melanjutkan kembali silahkan anda login ulang.')
                      .tsBodyM()
                      .center(),
                ),
                child: Column(
