...
import 'package:app.rynest.aasi/common/widgets/custom_panel.dart';
  ...
  Future<VersionInfo?> _getiOSStoreVersion(
    ...
    return await dio.getUri(uri).then((res) {
      ...
      return VersionInfo._(
        ...
        image: jsonObj['results'][0]['artworkUrl512'],
        title: jsonObj['results'][0]['trackName'],
        releaseDate: (jsonObj['results'][0]['releaseDate'] as String).toDateTime(),
